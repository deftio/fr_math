...
<!-- saved from url=(0051)http://www.dcs.gla.ac.uk/~jhw/cordic/cordic-32bit.h -->
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"></head><body><pre style="word-wrap: break-word; white-space: pre-wrap;">//Cordic in 32 bit signed fixed point math
